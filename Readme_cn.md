...
2.  <a name="zh-cn_topic_0228461777_li3208251440"></a>常规部署，请参考：  [https://github.com/Atlas200dk/sample-README/tree/master/sample-videoanalysisperson](https://github.com/Atlas200dk/sample-README/tree/master/sample-videoanalysisperson)  。
...
4.  开始编译，打开Mind Studio工具，在工具栏中点击**Build \> Build \> Build-Configuration**。如[图 编译操作及生成文件](#zh-cn_topic_0228461777_zh-cn_topic_0203223281_fig1625447397)所示，会在目录下生成build和run文件夹。
